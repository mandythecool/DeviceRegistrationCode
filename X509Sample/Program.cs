...
namespace Microsoft.Azure.Devices.Provisioning.Client.Samples
{
    public static class Program
    {
        ...
        private static string s_certificateFileName = @"D:\Code\Diality\CACerts\CACertificates\mydevice4.pfx";
        ...
        public static int Main(string[] args)
        {
            ...
            s_idScope = "0ne00116B8A";
            //s_idScope = "0ne00114670";
            ...
            // using (var transport = new ProvisioningTransportHandlerMqtt(TransportFallbackType.WebSocketOnly))
            {
                ...
                //provClient.RegisterAsync(new ProvisioningRegistrationAdditionalData() { JsonData = "{\"DeviceAdditionalInfo\" : \"Test Device 123\"}"});
                provClient.ProductInfo = "{\"DeviceAdditionalInfo\" : \"Test Device 123\"}";
